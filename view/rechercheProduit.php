...
$ligne=ProduitDao::GetProduit($_REQUEST['reference']);
if ($ligne->rowCount()==0){
	?><p>ce produit de reference <?=$_REQUEST['reference']?> n'existe pas dans la base de donnees clickez vous sur ajouter produit pour l'ajouter</p><?php
}else{
?>
